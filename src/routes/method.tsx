  ...
  head: () => ({
    meta: [
      { title: "The Integral Method™ — Integral Values Psy & Co" },
      {
        name: "description",
        content:
          "The Integral Method™ brings together AQAL, the Integrative Coaching Mindset™, CARE & CORE™, Psyché™ and the Integral Transformation Journey™.",
      },
      { property: "og:title", content: "The Integral Method™ — our DNA" },
      {
        property: "og:description",
        content:
          "A philosophy and a practice: AQAL, CARE & CORE™ and the Integral Transformation Journey™.",
      },
...
const PARTS = [
  ...
  },
  {
    ...
    body: "Body, Brain, Emotion and Consciousness are held as equal dimensions of one human system rather than arranged in a hierarchy.",
  },
  {
    meta: "04",
    title: "The Integrative Coaching Mindset™",
    body: "Deep listening before technique. A stance that stays with the person rather than reducing them to the presenting problem.",
  },
  {
    meta: "05",
    title: "CARE & CORE™",
    body: "Care supports balance and safety; CORE brings Body, Brain, Emotion and Consciousness back into relationship.",
  },
  {
    meta: "06",
    title: "Psyché™",
    body: "Psychological and leadership assessment used as a reflective map to make the rest of the work more precise.",
  },
] as const;
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-24">
          <div>
            ...
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-muted-foreground">
              ...
              from self-knowledge to greater integration.
            </p>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <Link to="/psyche" className={journeyLinkClass} aria-label="Discover Psyché">
            <CardTile
              ...
              title="Psyché™"
              body="Psychological and leadership assessment. Self-awareness is the first step toward meaningful change."
            />
          </Link>
          ...
          <Link to="/counselling" className={journeyLinkClass} aria-label="Discover Care & Therapy">
            <CardTile
              meta="Heal deeply"
              title="Care & Therapy"
              body="A protected space to restore emotional balance, understand patterns and reconnect with what matters."
            />
          </Link>
          ...
          <Link to="/coaching" className={journeyLinkClass} aria-label="Discover Coaching">
            <CardTile
              ...
              title="Coaching"
              body="Turn reflection into action and develop conscious leadership. Growth starts from within."
            />
          </Link>
          ...
          <Link to="/cross-culture" className={journeyLinkClass} aria-label="Discover Cross-Culture">
            <CardTile
              ...
              title="Cross-Culture"
              body="Build bridges across cultures, identities and teams. Diversity becomes strength when people truly connect."
            />
          </Link>
          ...
          <div className="md:col-span-2">
            <Link to="/core" className={journeyLinkClass} aria-label="Discover CORE">
              <CardTile
                meta="Become whole"
                title="CORE"
                body="Our integrative pathway for bringing Body, Brain, Emotion and Consciousness into greater alignment."
              />
            </Link>
          </div>
        </div>
