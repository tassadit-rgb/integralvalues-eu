          ...
          <aside className="space-y-10">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Choose the format that fits your needs. Session fees are handled in the booking and payment journey rather than displayed on this public page.
              </p>
              <Link
                to="/booking"
            ...
            <p className="border-l border-gold pl-5 text-sm leading-relaxed text-muted-foreground">
              Money should not prevent you from getting help. We can explore a payment solution adapted to your situation.
            </p>
          </aside>
        </div>
      </Section>
